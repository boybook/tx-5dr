...
MSG_EN_CHECK_NGINX_UPLOAD_LIMIT="nginx upload size limit"
MSG_ZH_CHECK_NGINX_UPLOAD_LIMIT="nginx 上传大小限制"
MSG_EN_FIX_NGINX_UPLOAD_LIMIT="Repair nginx upload limit: sudo tx5dr doctor --fix"
MSG_ZH_FIX_NGINX_UPLOAD_LIMIT="修复 nginx 上传大小限制: sudo tx5dr doctor --fix"
...
MSG_EN_FIX_NODEJS="Install Node.js 22: curl -fsSL https://deb.nodesource.com/setup_22.x | sudo bash -"
MSG_ZH_FIX_NODEJS="安装 Node.js 22: curl -fsSL https://deb.nodesource.com/setup_22.x | sudo bash -"
...
MSG_EN_GLIBCXX_WARN="This may also upgrade libc6 (glibc)."
MSG_ZH_GLIBCXX_WARN="此操作可能连带升级 libc6 (glibc)。"
